        ...
        <section className="mb-4">
          ...
          <div className="space-y-2">
            <p className="text-[13px] font-mono opacity-90 leading-[1.6]">
              <span className="font-bold">Initialized by curiosity</span>, my tech journey quickly compiled into a core directive. Operating out of <span className="font-bold border-b border-ink/40">New Delhi</span>, I engineer intelligent logic—fusing <span className="bg-hl-yellow-bg border-b-2 border-hl-yellow-border font-bold px-1">machine learning</span> with robust <span className="bg-hl-blue-bg border-b-2 border-hl-blue-border font-bold px-1">full-stack architecture</span>. <span className="font-bold tracking-widest uppercase text-xs">I explore, I build, I deploy.</span>
            </p>
            <p className="text-[13px] font-mono opacity-90 leading-[1.6]">
